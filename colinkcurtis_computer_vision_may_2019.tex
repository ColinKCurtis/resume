%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Colin K Curtis Resume for Computer Vision Software
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Updated May 21, 2019
%%%%%%%%
...
\begin{document}
\Huge \bfseries {\color{Blue} Colin K. Curtis - Software for Computer Vision}
...
\begin{compactitem}[\color{Blue}$\circ$]
    \SmallSep
    \item Tire Footprint Visualization and Analysis
    \SmallSep
    \item Deep-learning for facial analysis in automotive settings
    \SmallSep
    \item Computational geometry techniques including alpha shape generation
    \SmallSep
    \item Measurement and presentation of physical parameters for engineering and design
    \SmallSep
    \item Machine-learning techniques for automatic analysis of many distinct tires
...
\CVItem{Research Software Engineer - Renaissance Computing Institute (RENCI); \textit{June 2018 - March 2019}}
\begin{compactitem}[\color{Blue}$\circ$]
    \SmallSep
