%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Colin K Curtis Resume for Software Engineer
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{compactitem}
    ...
    \item \textbf{Developer} - Current team member in the development of an automotive-industry, production-ready CAD system
    \SmallSep
...
\begin{compactitem}[\color{Blue}$\circ$]
    ...
    engineers and material scientists on an in-house CAD system for an industry-leading automotive company.
    The system is written with Python3 and React.js.
    \SmallSep
