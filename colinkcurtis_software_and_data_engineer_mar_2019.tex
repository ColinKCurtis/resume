%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Colin K Curtis Resume for Software and Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{compactitem}[\color{Blue}$\circ$]
    ...
    \SmallSep
    \item Automated creation of Flask APIs based on large data files using 'Jinja2' scripting for Python
    \SmallSep
    \item Embedded SQL and SPARQL queries within Python scripts to stream-line query interfaces
    \SmallSep
